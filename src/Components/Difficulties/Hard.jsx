...
const Medium = () => {
    ...
    const resetGame = () => {
       ...
       let timeValue;
       if (difficulty === "easy") {
           timeValue = (300 - replayCount*10);
           dispatch(updateTime(timeValue));
       }
       if (difficulty === "medium") {
           timeValue = (270 - replayCount*10);
           dispatch(updateTime(timeValue));
       }
       if (difficulty === "hard") {
           timeValue = (240 - replayCount*10);
           dispatch(updateTime(timeValue));
       }
        ...
        if (difficulty === "hard") {
            ...
            initialCardsData.push({ id: 47, name: 'bonus' });
            initialCardsData.push({ id: 48, name: 'bonus' });
            initialCardsData.push({ id: 49, name: 'bonus' });
        } else {
            // Add name:8 cards for other difficulties
            initialCardsData.push({ id: 47, name: '16' });
            initialCardsData.push({ id: 48, name: '16' });
            initialCardsData.push({ id: 49, name: '16' });
        }
